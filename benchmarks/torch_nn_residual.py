# STATUS: EXPERIMENTAL
# Purpose: NN ensemble with residual connection (MLP predicts residuals).
# The residual branch is zero-initialized so it starts at 0.
...
class ResidualNNModel(nn.Module):
    ...
    def forward(self, inputs: torch.Tensor) -> torch.Tensor:
        ...
        # Residual: mean + small initial delta
...
def main() -> None:
    ...
    model_name = f"torch_nn_residual({','.join(e3)})"
