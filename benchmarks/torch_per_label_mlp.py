...
def main() -> None:
    ...
    # Stage 1 needs model/optimizer explicitly now
    base_m1 = PerLabelWeightedEnsemble(n_models=n_models, n_labels=n_labels).to(DEVICE)
    opt_m1 = optim.AdamW(base_m1.parameters(), lr=0.003)
