# STATUS: EXPERIMENTAL
# Purpose: torch_per_label_softmax_global + active-label Low-Rank cross-label mixer (RANK 16).
#
# Simplification 3 from SIMPLIFY.md: Reduce DEFAULT_RANK from 64 to 16.
...
def main() -> None:
    ...
    model_name = f"torch_per_label_softmax_global_active_lowrank_rank16({','.join(ensemble_keys)})"
