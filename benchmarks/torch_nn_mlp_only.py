# STATUS: EXPERIMENTAL
# Purpose: NN ensemble with only MLP (no Conv1d mean).
...
class MLPOnlyNNModel(nn.Module):
    def __init__(
        self,
        source_dim: int,
        input_dim: int,
    ...
    def reset_parameters(self) -> None:
        # No mean initialization - pure MLP
...
def main() -> None:
    ...
    model_name = f"torch_nn_mlp_only({','.join(e3)})"
