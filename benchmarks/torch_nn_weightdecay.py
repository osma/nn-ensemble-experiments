# STATUS: EXPERIMENTAL
# Purpose: NN ensemble with aggressive weight decay (0.1) and no dropout.
...
LR = 1e-3
WEIGHT_DECAY = 0.1  # Aggressive weight decay
TRAIN_SEED = 0
...
class WeightDecayNNModel(nn.Module):
    def __init__(
        self,
        source_dim: int,
        input_dim: int,
...
def main() -> None:
    ...
    model_name = f"torch_nn_weightdecay({','.join(e3)})"
