# STATUS: EXPERIMENTAL
# Purpose: torch_per_label variant with softmax-constrained global weights + per-label residuals.
from pathlib import Path
import sys
import time

# Allow running as a script: `uv run benchmarks/torch_per_label_softmax_global.py`
...
class PerLabelSoftmaxGlobalEnsemble(nn.Module):
    """
...
def train_and_evaluate(
    *,
    ...
    model = PerLabelSoftmaxGlobalEnsemble(
        n_models=n_models,
        n_labels=n_labels,
