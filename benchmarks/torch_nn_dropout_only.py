# STATUS: EXPERIMENTAL
# Purpose: NN ensemble with only dropout (no weight decay).
...
class DropoutOnlyNNModel(nn.Module):
    def __init__(
        self,
        source_dim: int,
        input_dim: int,
...
def main() -> None:
    ...
    model_name = f"torch_nn_dropout_only({','.join(e3)})"
