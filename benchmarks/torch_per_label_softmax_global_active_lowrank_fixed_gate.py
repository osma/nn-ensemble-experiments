# STATUS: EXPERIMENTAL
# Purpose: torch_per_label_softmax_global_active_lowrank simplification: FIXED GATE.
#
# Simplification 2 from SIMPLIFY.md:
# Replace learnable gate with a fixed constant gate = 0.02.
# Removes raw_gate parameter and DELTA_GATE_MAX hyperparameter.
...
def train_and_evaluate(
    *,
    ...
    # Use a two-tiered learning rate, but remove raw_gate
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        avg_grad_norm = sum_grad_norm / max(1, n_batches)
        ...
        print(
            f"Epoch {epoch:02d} | loss={float(last_loss or 0.0):.6f} | grad_norm={avg_grad_norm:.6f} | "
...
def main() -> None:
    ...
    model_name = f"torch_per_label_softmax_global_active_lowrank_fixed_gate({','.join(ensemble_keys)})"
